...
export const Banner = () => {
  ...
  const renderDownloadResume = () => {
    ...
    document.body.removeChild(downloadResume);
  };
            ...
            <TrackVisibility>
              {({ isVisible }) => (
                ...
                >
                  ...
                  <p>
                    My name is Pawaris Rabeab. I graduated with a bachelor's
                    degree from Chiang Mai University, majoring in Computer
                    Engineering. I currently work as a frontend engineer.
                  </p>
                  <button onClick={renderDownloadResume}>
